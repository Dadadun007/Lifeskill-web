...
function Signup() {
        ...
        const [passwordMismatch, setPasswordMismatch] = useState(false); // 🔹 เพิ่ม
      ...
      return  (
          <div className="flex flex-col justify-center items-center h-screen bg-[#373737]">
            ...
            <div className="flex flex-col">
                <label htmlFor="Confirmed Password" className="font-medium text-lg text-gray-700 flex items-center gap-1">
                  <img src="/lock.png" alt="pass icon" className="w-5 h-5" />
                    Confirmed Password
                </label>
              <input
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col ">
                  <label htmlFor="gender" className="font-medium text-lg text-gray-700 flex items-center ">
                  ...
                  <div className="flex gap-2">
                        ...
                        return (
                              <button
                                  ...
                                  className={`
                                    px-2 py-2 rounded-full text-sm font-medium border
